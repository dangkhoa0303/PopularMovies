...
public class FetchMoviesService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        broadcastIntent.setAction(MoviesFragment.MoviesServiceReceiver.MOVIES_LIST_RECEIVER);
        broadcastIntent.putParcelableArrayListExtra(KEY_RESPONSE, list_movie);
